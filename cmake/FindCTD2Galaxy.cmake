...
IF(PYTHONINTERP_FOUND)
	IF(CTDOPTS_MODULE)
		...
		ELSE()	
			MESSAGE(WARNING "CTD2Galaxy could not be found.")
		ENDIF()
	ELSE()
		MESSAGE(WARNING "CTD2Galaxy depends on CTDopts and it could not be found.")
	ENDIF()
ELSE()
	MESSAGE(WARNING "CTD2Galaxy depends on PythonInterp, which was not found.")	
ENDIF()
