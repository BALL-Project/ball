...
IF(FLEX_EXECUTABLE)
  ...
  IF(NOT ${FLEX_version_result} EQUAL 0)
    MESSAGE(FATAL_ERROR "Command \"${FLEX_EXECUTABLE} --version\" failed with output:\n${FLEX_version_error}")
  ELSE()
  ...
  MACRO(FLEX_TARGET Name Input Output)
    ...
    IF(${ARGC} GREATER 3)
      IF(${ARGC} EQUAL 5)
        ...
        ELSE()
	  MESSAGE(FATAL_ERROR ${FLEX_TARGET_usage})
        ENDIF()
      ELSE()
	MESSAGE(FATAL_ERROR ${FLEX_TARGET_usage})
      ENDIF()
  ...
  MACRO(ADD_FLEX_BISON_DEPENDENCY FlexTarget BisonTarget)
    ...
    IF(NOT FLEX_${FlexTarget}_OUTPUTS)
      MESSAGE(FATAL_ERROR "Flex target `${FlexTarget}' does not exists.")
    ENDIF()

    IF(NOT BISON_${BisonTarget}_OUTPUT_HEADER)
      MESSAGE(FATAL_ERROR "Bison target `${BisonTarget}' does not exists.")
    ENDIF()
