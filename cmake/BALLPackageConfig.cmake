...
IF (WIN32 AND NOT UNIX)
	# Install Qt5 dynamic libraries and its plugins
	GET_TARGET_PROPERTY(Qt5Core_LOCATION Qt5::Core LOCATION)
	GET_FILENAME_COMPONENT(Qt5_DLL_PATH ${Qt5Core_LOCATION} PATH)
	INSTALL(DIRECTORY ${Qt5_DLL_PATH}/ DESTINATION ${BALL_RUNTIME_INSTALL_DIRECTORY} USE_SOURCE_PERMISSIONS COMPONENT "Runtime" FILES_MATCHING PATTERN "*.dll")
	INSTALL(DIRECTORY ${Qt5_DLL_PATH}/../plugins/ DESTINATION ${BALL_RUNTIME_INSTALL_DIRECTORY} USE_SOURCE_PERMISSIONS COMPONENT "Runtime")
...
ELSEIF(APPLE)
	...
	SET(CPACK_PACKAGE_FILE_NAME "BALL-${CF_BALL_PACKAGE_VERSION}-macOS-${MACOS_PRODUCT_VER}")
