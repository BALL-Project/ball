...
ELSE()
	...
	IF (BALL_HAS_TR1_UNORDERED_MAP)
		UNSET(BALL_HAS_TR1_UNORDERED_MAP CACHE)
		BALL_HASH_MAP_COMPILES("eeunordered_map" "std::tr1" "tr1/unordered_map" BALL_HAS_TR1_UNORDERED_MAP)
	ENDIF()
	IF (BALL_HAS_TR1_UNORDERED_MAP)
		...
		SET(BALL_HAS_UNORDERED_MAP TRUE)
	ELSE()
		CHECK_INCLUDE_FILE_CXX("boost/unordered_map.hpp" BALL_HAS_BOOST_UNORDERED_MAP ${COMPILE_DEFINITIONS})
		IF (BALL_HAS_BOOST_UNORDERED_MAP)
			UNSET(BALL_HAS_BOOST_UNORDERED_MAP CACHE)
...
IF (NOT BALL_HAS_UNORDERED_MAP)
	...
	FOREACH(TMP_EXT_INCLUDE_PREFIX "" "ext/")
		UNSET(EXT_INCLUDE_PREFIX_FOUND CACHE)
	...
	IF (EXT_INCLUDE_PREFIX_FOUND)
		...
		FOREACH(TMP_EXT_NAMESPACE "std" "stdext" "__gnu_cxx")
			UNSET(EXT_NAMESPACE_FOUND CACHE)
