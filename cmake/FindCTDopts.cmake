...
IF (PYTHONINTERP_FOUND)
	...
	ELSE()
		MESSAGE(WARNING "FindCTDopts.py returned with error or returned an unexpected output.\nstderr: ${stderr}\nstdout: ${stdout}\nexit code: ${exit_code}")
	ENDIF()
	IF (CTDOPTS_MODULE)
		MARK_AS_ADVANCED(CTDOPTS_MODULE)
		MESSAGE(STATUS "CTDopts module was found and seems to be working...")
	ELSE()
		MESSAGE(WARNING "CTDopts module could not be found.")
	ENDIF()
ELSE()
	MESSAGE(WARNING "CTDopts depends on PythonInterp, which was not found.")
ENDIF()