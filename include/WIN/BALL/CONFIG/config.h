...
// $Id: config.h,v 1.1.2.1 2002/11/29 19:50:54 oliver Exp $
...
#define BALL_PATH "/home/staff/oliver/BALL"
// the string describing the binary format
#define BALL_BINFMT "Linux-i386-g++_3.1.1"
...
#define BALL_POINTERSIZEINT_TYPE unsigned int
...
// Define whether the FFTW library may be included.
#define BALL_HAS_FFTW true
