	...
	namespace QSAR
	{
		...
		class FeatureSelection
		{
			public:
				...
				/** Does a simple single check of all features.\n
				First, the best feature to start with is searched. Then, for each remaining (non-empty) descriptor it is checked ONCE whether it can increase the prediction quality.\n
				...
				void singleScan(int k, bool optPar=0);
