...
// vi: set ts=2:
//
// $Id: modifyRepresentationDialog.h,v 1.1.2.4.2.1 2006/08/31 14:04:44 leonhardt Exp $
//
	...
	namespace VIEW
	{
		...
		*/
		...
		{ 
			...
			///
			ModifyRepresentationDialog(QWidget* parent = 0, const char* name = 0, bool modal = FALSE, Qt::WFlags fl = 0);
