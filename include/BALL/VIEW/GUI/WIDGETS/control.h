...
// vi: set ts=2:
//
// $Id: control.h,v 1.18 2003/08/26 08:05:03 oliver Exp $
...
namespace BALL
{
	namespace VIEW
	{
		...
		/**	Control is a widget to display the structure of Composite objects. 
		    ...
		    There are methods available to change the structure as well as
				copy or paste objects into the Control.
				...
				will be shown in the structure view of the Control.
		*/
		class Control
			: public QListView, 
				public ModularWidget
		{
				...
				: public QCheckListItem
			{
				...
				SelectableListViewItem(QListViewItem* parent, const QString& text, const QString& type, 
															 Composite* composite, VIEW::Control& control)
					throw();
		  ...
		  */
			...
			*/	
			...
			/** Default Constructor.
					...
					\param      parent the parent widget of the Control 
			...
			*/
			...
			/** Send the selection with a ControlSelectionMessage.
					Override this method if other messages should be sent.
			*/
			virtual void sendSelection();
