// $Id: control.h,v 1.1 2000/09/23 12:50:26 hekl Exp $

#ifndef BALL_VIEW_OPENGL_WIDGETS_CONTROL_H
#define BALL_VIEW_OPENGL_WIDGETS_CONTROL_H
...
#			include <BALL/VIEW/OPENGL/WIDGETS/control.iC>
#		endif

#endif // BALL_VIEW_OPENGL_WIDGETS_CONTROL_H_
