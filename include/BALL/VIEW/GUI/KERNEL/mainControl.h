// $Id: mainControl.h,v 1.14 2001/02/11 13:04:39 hekl Exp $
				...
				public Embeddable
		{
			...
			*/
			...
			/** Default Constructor.
					...
					{\em aboutToQuit} with the slot \Ref{MainControl::aboutToExit}.
					...
					@see    INIFile::INIFile
					@see    Preferences::Preferences
					@see    MainControlPreferences::MainControlPreferences
			*/
         ...
         const String& name = "unkown",
			...
			*/
			...
			/** Remove a composite.
					...
					@see    MainControl::insert
					@see    Composite::Composite
					@see    RemoveCompositeMessage::RemoveCompositeMessage
			...
			*/
			...
			/** Marks all inserted composite objects for update.
					Same as \Ref{MainControl::update} but all inserted \Ref{Composite} objects
			...
			*/
			...
			/** Message handling method.
					...
					@see   ModularWidget::ModularWidget
					@see   Message::Message
		  */
			...
			*/
			...
			/**	Modular widget initialization.
					...
					Calls \Ref{MainControl::initializePreferencesTab}
					Calls \Ref{MainControl::fetchPreferences}
					Calls \Ref{MainControl::applyPreferences}
					Calls \Ref{MainControl::insertMenuEntry}
				  ...
				  @see        ModularWidget::ModularWidget
					@see        MainControl::initializePreferencesTab
					@see        MainControl::fetchPreferences
					@see        MainControl::applyPreferences
					@see        MainControl::insertMenuEntry
			...
			*/
			...
			/** Last second cleanup.
					...
					Calls \Ref{MainControl::writePreferences}
					Calls \Ref{MainControl::finalizePreferencesTab}
					Calls \Ref{MainControl::removeModularWidget}
				  ...
				  @see   ModularWidget::ModularWidget
					...
					@see   MainControl::writePreferences
					@see   MainControl::finalizePreferencesTab
					@see   MainControl::removeModularWidget
					@see   INIFile::write
			*/
			...
			*/
			...
			/** Insert a new menu entry.
					...
					@see   MainControl::removeMenuEntry
			*/
			int insertMenuEntry
				(int ID, const String& name, const QObject* receiver = 0, 
				 const char* slot = 0, int accel = 0, int entry_ID = -1);
			...
			/**	Initialize a popup menu.
					...
					@see      MainControl::PopUpID
					@see      QPopupMenu::QPopupMenu
			*/	
			...
			*/
			...
			/** Initialize a preferences tab for the mainControl.
					...
					This method is called automatically by the \Ref{MainControl::show} method at the
			...
			*/
			...
			/**	Remove the preferences tab.
					...
					This method is called automatically by the \Ref{MainControl::aboutToExit}
			...
			*/
			...
			/** Apply the preferences of the specific tab.
					...
					This method is called automatically by the \Ref{MainControl::applyPreferencesTab}
					...
					@param  preferences the \Ref{Preferences} dialog for {\em *this} mainControl
					@see    MainControl::applyPreferencesTab
					@see    MainControlPreferences::MainControlPreferences
					@see    Preferences::Preferences
			*/
