// $Id: mainControl.h,v 1.1 2000/09/23 12:49:57 hekl Exp $

#ifndef BALL_VIEW_OPENGL_KERNEL_MAINCONTROL_H
#define BALL_VIEW_OPENGL_KERNEL_MAINCONTROL_H
...
namespace BALL
{
	...
	namespace VIEW
	{
		...
		/**		MainControl class.
					...
					class.
					\\
					{\bf Definition:}\URL{BALL/VIEW/OPENGL/KERNEL/mainControl.h}
					\\
...
#			include <BALL/VIEW/OPENGL/KERNEL/mainControl.iC>
#		endif 
...
#endif // BALL_VIEW_OPENGL_KERNEL_MAINCONTROL_H
