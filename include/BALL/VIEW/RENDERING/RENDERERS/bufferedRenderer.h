...
#ifndef BALL_VIEW_RENDERING_REMDERERS_BUFFEREDRENDERER_H
#define BALL_VIEW_RENDERING_REMDERERS_BUFFEREDRENDERER_H

#ifndef BALL_VIEW_RENDERING_RENDERERS_RENDERER_H
# include <BALL/VIEW/RENDERING/REMDERERS/renderer.h>
#endif
