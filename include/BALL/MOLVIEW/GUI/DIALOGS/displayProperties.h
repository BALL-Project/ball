// $Id: displayProperties.h,v 1.17 2002/12/16 15:33:55 amoll Exp $
			  ...
			  public ModularWidget
		{
			...
			*/
			...
			enum Value
			{
				...
				VALUE__DRAWING_PRECISION_LOW    = 1,
				VALUE__DRAWING_PRECISION_MEDIUM = 2,
				VALUE__DRAWING_PRECISION_HIGH   = 3,
