...
namespace BALL 
{
	...
	namespace Constants 
	{
		...
		*/
		...
		/// Bohr radius in m ($5.29177249 \cdot 10^{-11}$ m)
		...
		*/
		...
		/// Calories per Joule (1/JOULE\_PER\_CAL)
