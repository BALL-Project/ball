...
namespace BALL {
	...
	class PPCurve
	{
		...
		*/
		...
		void setIntervals(vector<float>& intervals);

		/// set the interval limits of the ppcurve (const)
		...
		void setCoefficients(vector< vector<float> >& coefficients);

		/// set the coefficients of the ppcurve (const)
