		...
		*/
		...
		/**	Map three points onto each other.
				...
				\begin{itemize}
					...
					\item the point <tt>w2</tt> onto the ray that starts in <tt>v1</tt> and goes through {\tt v2},
					\item the point <tt>w3</tt> into the plane generated by <tt>v1</tt>, {\tt v2}, and {\tt v3}.
				\end{itemize}
		*/
