...
// vi: set ts=2:
//
// $Id: structureMapper.h,v 1.15 2003/03/03 14:18:22 anhi Exp $
...
namespace BALL 
{
	...
	/**	Structure mapping class.
			<b>Definition:</b> BALL/STRUCTURE/structureMapper.h
	*/
		...
		:	public TransformationProcessor
	{
		...
		*/
		...
		/**	Map three points onto each other.
				...
				\begin{itemize}
					\item the point <tt>w1</tt> onto the point <tt>v1</tt>,
					\item the point <tt>w2</tt> onto the ray that starts in <tt>v1</tt> and goes through <tt>v2</tt>,
					\item the point <tt>w3</tt> into the plane generated by <tt>v1</tt>, <tt>v2</tt>, and {\tt v3}.
				\end{itemize}
		*/
