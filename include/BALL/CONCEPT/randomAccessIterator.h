	...
	*/
		...
		: public BidirectionalManipulator_<Container, DataType, Position, Traits>
	{
		...
		*/
		...
		/**	
		*/
		RandomAccessManipulator(const RandomAccessManipulator& manipulator)
		...
		/**	
		*/
		RandomAccessManipulator(const BaseIterator<Container, DataType, Position, Traits> &iterator)
		...
		RandomAccessManipulator operator ++(int)
		{
			RandomAccessManipulator manipulator(*this);
			++(*this);
			return manipulator;
		}
		...
		RandomAccessManipulator &operator += (Distance distance)
		{
			if (!traits_ptr_->isValid())
				throw Exception::InvalidIterator(__FILE__, __LINE__);
		...
		RandomAccessManipulator operator + (Distance distance) const
		{
			RandomAccessManipulator manipulator(*this);
			return (manipulator += distance);
		}

		friend RandomAccessManipulator operator +
			(Distance distance, const RandomAccessManipulator& manipulator)
		{
			RandomAccessManipulator tmp_manipulator(manipulator);
			return (tmp_manipulator += distance);
		}
		...
		friend Distance operator -
			(const RandomAccessManipulator &a, const RandomAccessManipulator &b)
		{
		...
		bool operator < (const RandomAccessManipulator& manipulator) const
		{
			if (!traits_ptr_->isValid())
				throw Exception::InvalidIterator(__FILE__, __LINE__);
			if (!manipulator.traits_ptr_->isValid())
				throw Exception::InvalidIterator(__FILE__, __LINE__);
			if (traits_ptr_->getContainer() != manipulator.traits_ptr_->getContainer())
				throw Exception::IncompatibleIterators(__FILE__, __LINE__);
				
			return (bool)(*traits_ptr_ < *manipulator.traits_ptr_);
		}
		...
		bool operator <= (const RandomAccessManipulator& manipulator) const
		{
			...
			return (bool)!(*manipulator.traits_ptr_ < *traits_ptr_);
		}
		...
		{
			return ((RandomAccessManipulator *)this)->findFirst(predicate);
		}
		...
		{
			return ((RandomAccessManipulator *)this)->findLast(predicate);
		}
		...
		{
			return ((RandomAccessManipulator *)this)->findNext(predicate);
		}
		...
		{
			return ((RandomAccessManipulator *)this)->findPrevious(predicate);
		}
		...
		static RandomAccessManipulator begin(const Container& container)
		{
			RandomAccessManipulator manipulator(container);
			manipulator.toBegin();
			return manipulator;
		}

		static RandomAccessManipulator end(const Container& container)
		{
			RandomAccessManipulator manipulator(container);
			manipulator.toEnd();
			return manipulator;
		...
		static RandomAccessManipulator rbegin(const Container& container)
		{
			RandomAccessManipulator manipulator(container);
		...
		static RandomAccessManipulator rend(const Container& container)
		{
			RandomAccessManipulator manipulator(container);
			manipulator.toREnd();
			return manipulator;
		...
		RandomAccessManipulator(const Container& container)
