...
// vi: set ts=2:
//
// $Id: composite.h,v 1.60.4.1 2005/07/28 13:26:16 amoll Exp $
//
...
B		*/
		...
		*/
		...
		BALL_EXPORT class AncestorIteratorTraits
		{
			public:
		...
		BALL_EXPORT class ChildCompositeIteratorTraits
		{
			public:
		...
		BALL_EXPORT class CompositeIteratorTraits
		{
			public:
