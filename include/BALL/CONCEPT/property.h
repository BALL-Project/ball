...
// vi: set ts=2:
//
// $Id: property.h,v 1.39.4.1 2005/07/28 13:26:19 amoll Exp $
//
...
namespace BALL 
{
	...
	*/
	BALL_EXPORT class NamedProperty
	...
	/**	Property Manager class.
			...
			BALL_EXPORT class' attributes without changing its interface.
	...
	*/
	BALL_EXPORT class PropertyManager
	{
		public:
