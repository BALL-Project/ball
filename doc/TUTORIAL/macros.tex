...
\newcommand{\sbseries}{\fontseries{sb}}
% semibold: bold is TOO fat in the index
...
\newcommand{\class}[1]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#1}}
(BALL~class)}\index{BALL!classes!#1@{\ttfamily\sbseries{#1}}}}
...
\newcommand{\STLclass}[1]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#1}}
(STL~class)}\index{STL!#1 class@{\ttfamily\sbseries{#1}}}}
% STL class names are typeset in typewriter bold and indexed automatically:
%  - first with their class name
%  - then under STL!<classname> class

\newcommand{\function}[1]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#1}}
(BALL~function)}\index{BALL!functions!#1@{\ttfamily\sbseries{#1}}}}
...
\newcommand{\method}[1]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#1}}
(method)}\index{BALL!functions!#1@{\ttfamily\sbseries{#1}}}}
% method names are typeset in typewriter bold and indexed automatically:
%  - first with their name
%  - then under BALL!methods!<function name>

\newcommand{\attribute}[2]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#2}}
({\ttfamily\sbseries #1} attribute)}\index{BALL!!#1!#2@{\ttfamily\sbseries{#1}}}}
...
\newcommand{\macro}[1]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#1}}
(BALL~macro)}\index{BALL!macros!#1@{\ttfamily\sbseries{#1}}}}
% BALL macros names are typeset in typewriter bold and indexed automatically:
%  - first with their name
%  - then under BALL!macros!<macro name>

\newcommand{\namespace}[1]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#1}}
(BALL~namespace)}\index{BALL!namespaces!#1@{\ttfamily\sbseries{#1}}}}
% BALL macros names are typeset in typewriter bold and indexed automatically:
%  - first with their name
%  - then under BALL!namespaces!<name>

\newcommand{\type}[1]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#1}}
(BALL~type)}\index{BALL!types!#1@{\ttfamily\sbseries{#1}}}}
% BALL macros names are typeset in typewriter bold and indexed automatically:
%  - first with their name
...
\newcommand{\file}[1]{
	{\ttfamily\sbseries{#1}}
	\index{#1@{\ttfamily\sbseries{#1}} (file)}
}
...
\newcommand{\option}[1]{
	{\ttfamily\sbseries{#1}}
	\index{configure!options!#1@{\ttfamily\sbseries{#1}}}
}
% BALL file names are typeset in typewriter bold and indexed automatically:
% as configure/options/<name>"

\newcommand{\exception}[1]{{\ttfamily\sbseries{#1}}\index{#1@{\ttfamily\sbseries{#1}}
(BALL~class)}\index{BALL!exceptions!#1@{\ttfamily\sbseries{#1}}}}
...
\newcommand{\URL}[1]{{\bfseries\ttfamily\nobreak{#1}}}
\newcommand{\email}[1]{{\bfseries\ttfamily\nobreak{#1}}}
