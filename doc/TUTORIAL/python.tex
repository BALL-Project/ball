...
\textbf{Status note (v1.7):} The SIP-based Python bindings described in
this chapter are DISABLED in the v1.7 build
(\texttt{BALL\_PYTHON\_SUPPORT=OFF} in every \texttt{ci-*} CMake preset).
The chapter below is preserved for historical reference and as a feature
corpus. Phase~999.15 (targeted for v2.1) is the planned rewrite using a
modern Python binding generator. See \texttt{.planning/PYBALLV2.md} and
