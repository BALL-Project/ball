...
using the \member{add\_hydrogens}{} processor and rebuild the missing bonds
...
Finally, a call to \method{minimize} will cause the minimizer to run for
...
\method{MolecularDynamics}{simulate} method simulates a given number of MD
steps. 
