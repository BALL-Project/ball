...
\begin{lstlisting}{}
	S.apply(db.add\_hydrogens);
	S.apply(db.build\_bonds);
\end{lstlisting}
...
\begin{lstlisting}{}
	Selector hydrogen\_selector("element(H)");
	S.apply(hydrogen\_selector);
\end{lstlisting}
...
\begin{lstlisting}{}
	amber.options[PeriodicBoundary::Option::PERIODIC\_BOX\_ENABLED] 
			= true;
	amber.options[PeriodicBoundary::Option::PERIODIC\_BOX\_ADD\_SOLVENT] 
			= true;
	amber.setup(S);
\end{lstlisting}
