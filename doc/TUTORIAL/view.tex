...
\class{SnapshotVisualisation\-Dialog} & Visualization of trajectories\\
...
messaging system, that allows a \class{ModularWidget} to send a message which
...
To notify the other widgets, the \class{MolecularControl} sends a \class{ControlSelection\-Message}
...
With this information, the method \class{createGeometric\-Objects()} can then create the 
...
created a base class \class{ExtendedPreferences\-Object}, that defines an 
...
\class{ExtendedPreferences\-Object} classes can be designed and added.
