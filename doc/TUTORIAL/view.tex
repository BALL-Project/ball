...
The dialog's layout was done with the program "Qt Designer" 
(see ~\ref{designer}). This results in a source file, containing the base 
...
The following paragraphgraphs will discuss the actual implementation, starting 
...
separagraphte threads. A further functionality were the mulithreading technique
