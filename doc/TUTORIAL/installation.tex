...
(\URL{http://www.intel.com/support/graphics},
\URL{http://ati.amd.com/support/driver.html} and
...
(\URL{http://www.python.org}) and a recent version of SIP (version 4.5.2 or
above, available at \URL{http://www.riverbankcomputing.co.uk/sip/}). SIP is a
...
(version 3.1.2), available from \URL{http://www.fftw.org/}.
