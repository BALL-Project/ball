...
\index{compiler}
  ...
  It has been successfully built and tested on the following platforms:
	\begin{itemize}	
   	\item Linux/x86 2.x using g{\tt ++} 2.95.x and 3.0
   	\item Linux/x86 2.x using Kuck \& Associate (KAI) \CPP 4.0b
   	\item Solaris/SPARC 8 using g{\tt ++} 2.95.3
   	\item Solaris/SPARC 8 using Kuck \& Associate (KAI) \CPP 4.0b
   	\item Solaris/SPARC 8 using SUN Workshop CC 6.0 and 6.0u1
   	\item Solaris/x86 2.6 using g{\tt ++} 2.95.3
...
\begin{longtable}{lp{7cm}}\hline
  ...
  \option{--with-cxxflags}{\tt{}=FLAGS}&   add FLAGS to the C++ compiler flags
  ...
  \option{--with-python}&                  enable Python support\\\vspace{3mm}
