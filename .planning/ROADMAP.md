...
| 5.1 Build Warnings & Latent Bug Cleanup | 6/14 | In progress — Plans 01 + 03 + 04 + 05 + 07 + 09 complete (C4717 getline + -Wself-assign-field pairExp + -Wtautological representation + -Wformat-overflow CIFParserParser.y + C4910 BALL_EXPORT vector3/atom + C4834/C4996 GeneticIndividual+regressionModel); Plan 02 (C4311 audit) or 06 (-Wstringop-truncation strncpy) next Tier A | - |
