...
aps_or_terms: aps_term TK_APS_OR_TERM aps_or_terms { 
			GAFFCESParser::state.current_parser->current_predicate->addNewOR(GAFFCESParser::state.current_aps_type); 
		}
	| aps_term { 
			GAFFCESParser::state.current_parser->current_predicate->addNewOR(GAFFCESParser::state.current_aps_type);
		}
...
aps_term: TK_APS_DELOCALIZED connection { 
			GAFFCESParser::state.current_aps_type = (GAFFCESParser::APSMatcher::APSType) (GAFFCESParser::APSMatcher::DELOCALIZED_BOND + $2);
	}
	|	TK_APS_PURE_SINGLE_BOND connection {
		GAFFCESParser::state.current_aps_type = (GAFFCESParser::APSMatcher::APSType) (GAFFCESParser::APSMatcher::PURE_SINGLE_BOND + $2);
	}
	|	TK_APS_PURE_DOUBLE_BOND connection {
		GAFFCESParser::state.current_aps_type = (GAFFCESParser::APSMatcher::APSType) (GAFFCESParser::APSMatcher::PURE_DOUBLE_BOND + $2);
	}
	|	TK_APS_TRIPLE_BOND connection {
		// NOTE: GAFF does not distinguish between different kinds of triple bonds!
		GAFFCESParser::state.current_aps_type = (GAFFCESParser::APSMatcher::APSType) (GAFFCESParser::APSMatcher::TRIPLE_BOND + $2);
	}
	|	TK_APS_AROMATIC_BOND connection {
		GAFFCESParser::state.current_aps_type = (GAFFCESParser::APSMatcher::APSType) (GAFFCESParser::APSMatcher::AROMATIC_BOND + $2);
	}
	|	TK_APS_ALL_SINGLE_BONDS connection {
		GAFFCESParser::state.current_aps_type = (GAFFCESParser::APSMatcher::APSType) (GAFFCESParser::APSMatcher::SINGLE_BOND + $2);
	}
	|	TK_APS_ALL_DOUBLE_BONDS connection {
		GAFFCESParser::state.current_aps_type = (GAFFCESParser::APSMatcher::APSType) (GAFFCESParser::APSMatcher::DOUBLE_BOND + $2);
	}
