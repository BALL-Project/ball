...
#ballpath= os.path.join('..', '..', 

ballpath = ['/.autofs/home_student_betty/lisa/BALL/BALL_devel/include/']

#print os.path.dirname(ballpath)

from pygccxml import parser
from pygccxml import declarations

#configure GCC-XML parser
config = parser.config_t( gccxml_path=gccxml_09_path, include_paths=ballpath)

#parsing source file
decls = parser.parse( ['string.C'], config )
global_ns = declarations.get_global_namespace( decls )

n = global_ns.free_functions()
