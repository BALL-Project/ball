// $Id: MolmecSupport_bench.C,v 1.2 2002/06/16 19:12:55 oliver Exp $
...
START_BENCHMARK(MolmecSupport, 4.0, "$Id: MolmecSupport_bench.C,v 1.2 2002/06/16 19:12:55 oliver Exp $")
