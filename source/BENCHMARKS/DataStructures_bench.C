...
// vi: set ts=2:
//
// $Id: DataStructures_bench.C,v 1.3 2005/12/23 17:02:31 amoll Exp $
//
...
START_BENCHMARK(DataStructures, 11.0, "$Id: DataStructures_bench.C,v 1.3 2005/12/23 17:02:31 amoll Exp $")
