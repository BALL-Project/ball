...
// vi: set ts=2:
//
// $Id: KernelCreation_bench.C,v 1.3.2.1 2003/01/07 13:20:25 anker Exp $
...
START_BENCHMARK(KernelIteration, 1.0, "$Id: KernelCreation_bench.C,v 1.3.2.1 2003/01/07 13:20:25 anker Exp $")
