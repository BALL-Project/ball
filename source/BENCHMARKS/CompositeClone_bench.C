...
// vi: set ts=2:
//
// $Id: CompositeClone_bench.C,v 1.4.2.1 2003/01/07 13:20:24 anker Exp $
...
START_BENCHMARK(CompositeClone, 1.0, "$Id: CompositeClone_bench.C,v 1.4.2.1 2003/01/07 13:20:24 anker Exp $")
