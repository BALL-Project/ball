// $Id: CompositeClone_bench.C,v 1.1.2.1 2002/11/08 18:52:16 oliver Exp $
...
START_BENCHMARK(CompositeClone, 1.0, "$Id: CompositeClone_bench.C,v 1.1.2.1 2002/11/08 18:52:16 oliver Exp $")
