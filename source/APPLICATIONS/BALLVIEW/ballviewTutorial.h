...
#ifndef BALLVIEW_TUTORIAL_H
#define BALLVIEW_TUTORIAL_H
...
#include "ballviewTutorialData.h"
...
namespace BALL
{
	namespace VIEW
	{
		/**	Dialog for creating labels for a selection of molecular objects.
    		...
    		\ingroup  ViewDialogs
		*/
		class BALLViewTutorial : 
			public BALLViewTutorialData,
			public ModularWidget
		{
			Q_OBJECT
			BALL_EMBEDDABLE(BALLViewTutorial,ModularWidget)
			...
			*/	
			...
			/** Default Constructor.
					...
					@see        ModularWidget
			*/
			BALLViewTutorial(QWidget *parent = NULL, const char *name = NULL )
				throw();
