...
void DemoTutorialDialog::initTutorials_()
{
	...
	{
		setWindowTitle("Ray tracing Tutorial");
...
void DemoTutorialDialog::initializeWidget(MainControl&)
{
	...
	raytracing_tutorial_action_ = insertMenuEntry(MainControl::HELP, "Ray tracing Tutorial", this, SLOT(showRaytracingTutorial()), description);
	setMenuHint("Learn how to use RTFact");
	getMainControl()->insertPopupMenuSeparator(MainControl::HELP);
