...
CREATE TABLE `atom_charge` (
  ...
  `molecule_charge_id` int(11) default NULL,
  `charge` float default NULL,
  `atom_idx` int(2) default NULL,
  PRIMARY KEY  (`id`),
  KEY `molecule_charge_id` (`molecule_charge_id`),
...
CREATE TABLE `atom_coord` (
  ...
  `atom_idx` int(2) default NULL,
  PRIMARY KEY  (`id`),
  KEY `conformation_id` (`conformation_id`),
  KEY `atom_idx` (`atom_idx`)
...
--
-- Table structure for table `molecule_charge`
--

DROP TABLE IF EXISTS `molecule_charge`;
CREATE TABLE `molecule_charge` (
  `id` int(11) NOT NULL auto_increment,
  `topology_id` int(11) default NULL,
  `method_id` int(11) default NULL,
  PRIMARY KEY  (`id`),
