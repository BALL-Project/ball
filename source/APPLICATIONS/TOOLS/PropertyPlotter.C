...
int main(int argc, char* argv[])
{
	...
	parpars.registerMandatoryParameter("p1", "name of property 1", STRING);
	parpars.registerOptionalParameter("p2", "name of property 2", STRING);
	parpars.registerFlag("quiet", "be quiet, i.e. do not print progress information");
	parpars.registerOptionalParameter("o", "output png-/eps-file", OUTFILE);
