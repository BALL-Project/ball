...
int main(int argc, char* argv[])
{
	...
	par.registerMandatoryParameter("i","input mod-file",INFILE);
	par.registerMandatoryParameter("dat","data-file",INFILE);
	par.registerMandatoryParameter("o","output text file",OUTFILE);
	par.registerMandatoryParameter("type","feature-selection type",STRING);
