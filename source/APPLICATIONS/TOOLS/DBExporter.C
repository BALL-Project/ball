...
int main(int argc, char* argv[])
{
	...
	parpars.registerOptionalIntegerParameter("start_id", "ID of the first conformation to be exported");
	parpars.registerOptionalIntegerParameter("end_id", "ID of the last conformation to be exported");
	parpars.registerOptionalDoubleParameter("min_logP", "minimal logP value");
	parpars.registerOptionalDoubleParameter("max_logP", "maximal logP value");
	parpars.registerOptionalDoubleParameter("min_MW", "minimal molecular weight");
	parpars.registerOptionalDoubleParameter("max_MW", "maximal molecular weight");
	parpars.registerOptionalIntegerParameter("max_mols", "max. number of molecules to be exported");
	...
	parpars.registerOptionalDoubleParameter("min_sim", "minimal average similarity");
	parpars.registerOptionalDoubleParameter("max_sim", "maximal similarity");
	...
	parpars.registerOptionalStringParameter("uck", "UCK key");
