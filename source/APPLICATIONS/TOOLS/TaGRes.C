...
int main(int argc, char* argv[])
{
	...
	par.registerMandatoryParameter("mod", "model-file generated by TaGRes-train", INFILE);
	par.registerOptionalParameter("tf", "top-scored fraction of compounds not to be rescored", DOUBLE);
