...
**
** Created: Sun Apr 30 19:20:48 2000
...
void Mainframe::staticMetaObject()
{
    ...
    m1_t2 v1_2 = Q_AMPERSAND Mainframe::importPDB;
    m1_t3 v1_3 = Q_AMPERSAND Mainframe::cut;
    m1_t4 v1_4 = Q_AMPERSAND Mainframe::copy;
    m1_t5 v1_5 = Q_AMPERSAND Mainframe::paste;
    m1_t6 v1_6 = Q_AMPERSAND Mainframe::clearClipboard;
    m1_t7 v1_7 = Q_AMPERSAND Mainframe::select;
    m1_t8 v1_8 = Q_AMPERSAND Mainframe::deselect;
    m1_t9 v1_9 = Q_AMPERSAND Mainframe::checkResidue;
    m1_t10 v1_10 = Q_AMPERSAND Mainframe::buildBonds;
    m1_t11 v1_11 = Q_AMPERSAND Mainframe::addHydrogens;
    m1_t12 v1_12 = Q_AMPERSAND Mainframe::assignCharges;
    m1_t13 v1_13 = Q_AMPERSAND Mainframe::calculateAmberEnergy;
    m1_t14 v1_14 = Q_AMPERSAND Mainframe::amberMinimization;
    m1_t15 v1_15 = Q_AMPERSAND Mainframe::openDisplayPropertiesDialog;
    m1_t16 v1_16 = Q_AMPERSAND Mainframe::openPreferencesDialog;
    m1_t17 v1_17 = Q_AMPERSAND Mainframe::centerCamera;
    m1_t18 v1_18 = Q_AMPERSAND Mainframe::about;
    m1_t19 v1_19 = Q_AMPERSAND Mainframe::applyPreferencesDialog;
    QMetaData *slot_tbl = QMetaObject::new_metadata(20);
    slot_tbl[0].name = "checkMenuEntries()";
    slot_tbl[1].name = "importHIN()";
    slot_tbl[2].name = "importPDB()";
    slot_tbl[3].name = "cut()";
    slot_tbl[4].name = "copy()";
    slot_tbl[5].name = "paste()";
    slot_tbl[6].name = "clearClipboard()";
    slot_tbl[7].name = "select()";
    slot_tbl[8].name = "deselect()";
    slot_tbl[9].name = "checkResidue()";
    slot_tbl[10].name = "buildBonds()";
    slot_tbl[11].name = "addHydrogens()";
    slot_tbl[12].name = "assignCharges()";
    slot_tbl[13].name = "calculateAmberEnergy()";
    slot_tbl[14].name = "amberMinimization()";
    slot_tbl[15].name = "openDisplayPropertiesDialog()";
    slot_tbl[16].name = "openPreferencesDialog()";
    slot_tbl[17].name = "centerCamera()";
