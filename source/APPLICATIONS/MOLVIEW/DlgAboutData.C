             ...
             : QDialog(parent, name, TRUE, 464)
{
    ...
    qtarch_Label_4->setGeometry(27, 5, 305, 52);
    ...
    qtarch_Label_4->setText( "MOLVIEW V 0.9 alpha" );
    ...
    qtarch_PushButton_4->setGeometry(150, 334, 59, 30);
    ...
    {
        QPixmap pixmap;
        pixmap.load("/KM/comp-bio/data/oliver/BALL/source/APPLICATIONS/MOLVIEW/BALL_logo_large.bmp");
