...
namespace BALL
{
	...
	{
		Options options;
		options[NumericalSAS::Option::NUMBER_OF_POINTS] = number_of_dots;
		options[NumericalSAS::Option::PROBE_RADIUS    ] = probe_radius;
		options[NumericalSAS::Option::COMPUTE_VOLUME  ] = false;

		NumericalSAS numerical_sas(options);
		numerical_sas(fragment);

		atom_areas = numerical_sas.getAtomAreas();
		
		return  numerical_sas.getTotalArea();
	}

	float calculateSASArea(const AtomContainer& fragment, float probe_radius, Size number_of_dots)
	{
		Options options;
		options[NumericalSAS::Option::NUMBER_OF_POINTS] = number_of_dots;
		options[NumericalSAS::Option::PROBE_RADIUS    ] = probe_radius;
		...
		(const AtomContainer& fragment, float probe_radius, Size number_of_dots)
	{
		...
		options[NumericalSAS::Option::NUMBER_OF_POINTS] = number_of_dots;
		options[NumericalSAS::Option::PROBE_RADIUS    ] = probe_radius;
		options[NumericalSAS::Option::COMPUTE_AREA    ] = false;
		options[NumericalSAS::Option::COMPUTE_VOLUME  ] = true;

		NumericalSAS numerical_sas(options);
		numerical_sas(fragment);
		
		return numerical_sas.getTotalVolume();
	}
  ...
  float calculateSASPoints
		 ...
		 float probe_radius,  Size number_of_dots)
	{
		...
		options[NumericalSAS::Option::NUMBER_OF_POINTS ] = number_of_dots;
		options[NumericalSAS::Option::PROBE_RADIUS     ] = probe_radius;
		options[NumericalSAS::Option::COMPUTE_AREA     ] = true;
		options[NumericalSAS::Option::COMPUTE_VOLUME   ] = false;
		options[NumericalSAS::Option::COMPUTE_SURFACE  ] = true;

		NumericalSAS numerical_sas(options);
		numerical_sas(fragment);
		
		surface = numerical_sas.getSurface();
  ...
  float calculateSASAtomPoints(const AtomContainer& fragment, 
			...
			float probe_radius,  Size number_of_dots)
	{
		...
		options[NumericalSAS::Option::COMPUTE_AREA     		 ] = true;
		options[NumericalSAS::Option::COMPUTE_VOLUME   		 ] = false;
		options[NumericalSAS::Option::COMPUTE_SURFACE_MAP  ] = true;

		NumericalSAS numerical_sas(options);
		numerical_sas(fragment);
		
		atom_surfaces = numerical_sas.getSurfaceMap();
