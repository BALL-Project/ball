...
namespace BALL
{
	...
	const double radius1 = 1.39e-10;	//Schleifenradius gross
	const double radius2 = 1.182e-10;	//Schleifenradius klein
	const double n1 = 3;					// number of aromatic electrons /2  for six-memeberd rings
	const double n2 = 3;					//    -- " --                       for five-membered rings
	...
	double betrag (const Vector3 & v)	// berechnet Betrag eines Vektors
	{
		double e = sqrt ((v * v));
		  return e;
	}
	...
	double JohnsonBoveyShift::rf (double x, double y, double z)
	{
	...
	double JohnsonBoveyShift::rd (double x, double y, double z)
	{
		//Lokale Konstanten Definitionen :
	...
	double JohnsonBoveyShift::ellf (double phi, double ak)
	{
		/*
	...
	double JohnsonBoveyShift::elle (double phi, double ak)
	{
		/*
