...
**
** Created: Fri Nov 29 17:40:08 2002
**      by:  The User Interface Compiler (uic)
**
** WARNING! All changes made in this file will be lost!
****************************************************************************/
#include "../../../../include/BALL/MOLVIEW/GUI/DIALOGS/contourSurfaceDialogData.h"
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    location_edit->setGeometry( QRect( 10, 40, 290, 26 ) ); 
    ...
    choose_button->setGeometry( QRect( 160, 40, 150, 80 ) ); 
    QPalette pal;
    QColorGroup cg;
