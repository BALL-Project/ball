// $Id: molecularControl.C,v 1.6.4.7 2002/11/30 11:37:29 oliver Exp $
	...
	namespace MOLVIEW
	{
		...
		*/
		...
		void MolecularControl::buildContextMenu(Composite* composite, QListViewItem* item)
			throw()
		{
			VIEW::Control::buildContextMenu(composite, item);
