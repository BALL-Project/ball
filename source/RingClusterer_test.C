...
// vi: set ts=2:
//
// $Id: RingClusterer_test.C,v 1.1.2.1 2006/06/26 18:38:49 oliver Exp $
//
// Author:
//  Holger Franken
//
...
START_TEST(RingClusterer, "$Id: RingClusterer_test.C,v 1.1.2.1 2006/06/26 18:38:49 oliver Exp $")
