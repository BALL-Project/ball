...
public:
	...
	bool hasFormat(String&) const;
	bool hasFormat();
	static bool sipVH_hasFormat(const sipMethodCache *,sipThisType *,int,String&);
...
extern SIP_EXPORT void sipConvertTo_File Py_PROTO((PyObject *,File **,int *));
