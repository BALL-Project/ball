...
PyObject *sipNew_ForceFieldComponent(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	if (sipNew == NULL)
	{
		...
		if (sipParseArgs(sipArgs,"-Il",sipCanConvertTo_ForceFieldComponent,&a0obj,&a1))
		{
			int iserr = 0;
...
void sipConvertTo_ForceFieldComponent(PyObject *sipPy,ForceFieldComponent **sipCppPtr,int *sipIsErr)
{
...
ForceFieldComponent *sipForceConvertTo_ForceFieldComponent(PyObject *valobj,int *iserrp)
{
	...
	if (sipCanConvertTo_ForceFieldComponent(valobj))
	{
		...
		sipConvertTo_ForceFieldComponent(valobj,&val,iserrp);
