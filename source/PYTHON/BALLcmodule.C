...
char sipName_BALL_getSnapShot[] = "getSnapShot";
...
char sipName_BALL_kinetic_energy[] = "kinetic_energy";
char sipName_BALL_potential_energy[] = "potential_energy";
char sipName_BALL_no_of_atoms[] = "no_of_atoms";
char sipName_BALL_data_length[] = "data_length";
char sipName_BALL_total_length[] = "total_length";
char sipName_BALL_index[] = "index";
char sipName_BALL_valid[] = "valid";
...
static sipClassDef classesTable[] = {
	...
	{sipName_BALL_SnapShot, sipNew_SnapShot, &sipClass_SnapShot, sipClassAttrTab_SnapShot, sipClassVarHierTab_SnapShot},
