...
class ForceField:
	...
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(8,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(8,self,name,value)
...
class Gradient:
	...
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(5,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(5,self,name,value)

class SnapShotManager:
	def __init__(self,*args):
		libBALLc.sipCallCtor(4,self,args)
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(4,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(4,self,name,value)

class EnergyMinimizer:
	def __init__(self,*args):
		libBALLc.sipCallCtor(3,self,args)
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(3,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(3,self,name,value)
...
class ConjugateGradientMinimizer(EnergyMinimizer):
	...
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(2,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(2,self,name,value)

class PeriodicBoundary:
	def __init__(self,*args):
		libBALLc.sipCallCtor(1,self,args)
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(1,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(1,self,name,value)
