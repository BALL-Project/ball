...
extern "C" PyObject *sipDo_CharmmTorsion_setup(PyObject *sipThisObj,PyObject *sipArgs)
{
	sipThisType *sipThis;
	int sipArgsParsed = 0;
...
extern "C" PyObject *sipDo_CharmmTorsion_updateEnergy(PyObject *sipThisObj,PyObject *sipArgs)
{
	sipThisType *sipThis;
	int sipArgsParsed = 0;
...
extern "C" PyObject *sipDo_CharmmTorsion_updateForces(PyObject *sipThisObj,PyObject *sipArgs)
{
	sipThisType *sipThis;
	int sipArgsParsed = 0;
...
extern "C" const void *sipCast_CharmmTorsion(const void *ptr,PyObject *targetClass)
{
	const void *res;
