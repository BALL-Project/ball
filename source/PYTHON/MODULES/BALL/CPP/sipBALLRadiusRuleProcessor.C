...
extern "C" PyObject *sipDo_RadiusRuleProcessor_CallOp(PyObject *sipThisObj,PyObject *sipArgs)
{
	sipThisType *sipThis;
	int sipArgsParsed = 0;
...
extern "C" const void *sipCast_RadiusRuleProcessor(const void *ptr,PyObject *targetClass)
{
	const void *res;
