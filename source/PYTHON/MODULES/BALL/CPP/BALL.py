# Python wrapper code.
#
# Generated by SIP v0.12 on Tue Apr 10 04:59:46 2001
...
class INIFile:
	...
	def __cmp__(self,other):
		return self.Operator__cmp__(other)
...
class Line3:
	...
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(70,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(70,self,name,value)
...
class Residue(Fragment):
	class Property:
		...
		PROPERTY__AMINO_ACID = PROPERTY__NON_STANDARD + 1
		PROPERTY__WATER = PROPERTY__NON_STANDARD + 2
		PROPERTY__HAS_SSBOND = PROPERTY__NON_STANDARD + 3
		PROPERTY__C_TERMINAL = PROPERTY__NON_STANDARD + 4
		PROPERTY__N_TERMINAL = PROPERTY__NON_STANDARD + 5
		PROPERTY__CYCLIC = PROPERTY__NON_STANDARD + 6
		NUMBER_OF_PROPERTIES = PROPERTY__NON_STANDARD + 7
