...
class RegularData3D(OutOfMemory,OutOfMemory,OutOfMemory,OutOfMemory,OutOfMemory,OutOfGrid,OutOfGrid,OutOfGrid,OutOfGrid,OutOfGrid,OutOfGrid,OutOfGrid):
	...
	class GridIndex:
		...
		def __del__(self):
			__sipDtor__(self)
		def __getattr__(self,name):
			return libBALLc.sipCallGetVar(96,self,name)
		def __setattr__(self,name,value):
			return libBALLc.sipCallSetVar(96,self,name,value)
...
class RegularData2D(OutOfMemory,OutOfMemory,OutOfMemory,OutOfMemory,OutOfMemory,OutOfGrid,OutOfGrid,OutOfGrid,OutOfGrid,OutOfGrid,OutOfGrid):
	...
	class GridIndex:
		...
		def __del__(self):
			__sipDtor__(self)
		def __getattr__(self,name):
			return libBALLc.sipCallGetVar(98,self,name)
		def __setattr__(self,name,value):
			return libBALLc.sipCallSetVar(98,self,name,value)
