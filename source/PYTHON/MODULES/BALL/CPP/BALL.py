...
class GridIndex:
	...
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(94,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(94,self,name,value)
...
class ForceField:
	...
	def __getattr__(self,name):
		return libBALLc.sipCallGetVar(49,self,name)
	def __setattr__(self,name,value):
		return libBALLc.sipCallSetVar(49,self,name,value)
