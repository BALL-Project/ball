...
static PyObject *sipDo_SecondaryStructure_set(PyObject *sipThisObj,PyObject *sipArgs)
{
...

	{
		...
		if (sipParseArgs(sipArgs,"I|l",sipCanConvertTo_SecondaryStructure,&a0obj,&a1))
		{
			...
			sipConvertTo_SecondaryStructure(a0obj,(SecondaryStructure **)&a0,&iserr);
...
void sipConvertTo_SecondaryStructure(PyObject *sipPy,SecondaryStructure **sipCppPtr,int *sipIsErr)
{
...
SecondaryStructure *sipForceConvertTo_SecondaryStructure(PyObject *valobj,int *iserrp)
{
	...
	if (sipCanConvertTo_SecondaryStructure(valobj))
	{
		...
		sipConvertTo_SecondaryStructure(valobj,&val,iserrp);
