...
static PyObject *sipDo_Options_setVector(PyObject *sipThisObj,PyObject *sipArgs)
{
...

	{
		...
		if (sipParseArgs(sipArgs,"II",sipCanConvertTo_String,&a0obj,sipCanConvertTo_Vector3,&a1obj))
		{
			...
			sipConvertTo_String(a0obj,&a0,&iserr);
			sipConvertTo_Vector3(a1obj,&a1,&iserr);
...
PyObject *sipNew_Options(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	if (sipNew == NULL)
	{
		...
		if (sipParseArgs(sipArgs,"-Il",sipCanConvertTo_Options,&a0obj,&a1))
		{
			...
			sipConvertTo_Options(a0obj,&a0,&iserr);
	...
	if (sipNew == NULL)
	{
		...
		if (sipParseArgs(sipArgs,"-I",sipCanConvertTo_Options,&a0obj))
		{
			...
			sipConvertTo_Options(a0obj,(Options **)&a0,&iserr);
...
void sipConvertTo_Options(PyObject *sipPy,Options **sipCppPtr,int *sipIsErr)
{
...
Options *sipForceConvertTo_Options(PyObject *valobj,int *iserrp)
{
	...
	if (sipCanConvertTo_Options(valobj))
	{
		...
		sipConvertTo_Options(valobj,&val,iserrp);
