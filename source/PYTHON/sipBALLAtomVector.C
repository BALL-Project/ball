...
static PyObject *sipDo_AtomVector_set(PyObject *sipThisObj,PyObject *sipArgs)
{
...

	{
		...
		if (sipParseArgs(sipArgs,"I",sipCanConvertTo_AtomVector,&a0obj))
		{
			...
			sipConvertTo_AtomVector(a0obj,(AtomVector **)&a0,&iserr);
...
static PyObject *sipDo_AtomVector_moveTo(PyObject *sipThisObj,PyObject *sipArgs)
{
...

	{
		...
		if (sipParseArgs(sipArgs,"If",sipCanConvertTo_Gradient,&a0obj,&a1))
		{
			...
			sipConvertTo_Gradient(a0obj,(Gradient **)&a0,&iserr);
...
PyObject *sipNew_AtomVector(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	if (sipNew == NULL)
	{
		...
		if (sipParseArgs(sipArgs,"-Il",sipCanConvertTo_AtomVector,&a0obj,&a1))
		{
			...
			sipConvertTo_AtomVector(a0obj,&a0,&iserr);
...
void sipConvertTo_AtomVector(PyObject *sipPy,AtomVector **sipCppPtr,int *sipIsErr)
{
...
AtomVector *sipForceConvertTo_AtomVector(PyObject *valobj,int *iserrp)
{
	...
	if (sipCanConvertTo_AtomVector(valobj))
	{
		...
		sipConvertTo_AtomVector(valobj,&val,iserrp);
