...
public:
	...
	sipPDBAtom(Element&,const String&,const String&,int,const Vector3&,const Vector3&,const Vector3&,float,float,char,char,char,float,float);
...
extern SIP_EXPORT void sipConvertTo_PDBAtom Py_PROTO((PyObject *,PDBAtom **,int *));
