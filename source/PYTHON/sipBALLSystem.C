...
const void *sipCast_System(const void *ptr,PyObject *targetClass)
{
	...
	if ((res = sipCast_Composite((Composite *)(System *)ptr,targetClass)) != NULL)
		return res;
...
void sipConvertTo_System(PyObject *sipPy,System **sipCppPtr,int *sipIsErr)
{
...
System *sipForceConvertTo_System(PyObject *valobj,int *iserrp)
{
	...
	if (sipCanConvertTo_System(valobj))
	{
		...
		sipConvertTo_System(valobj,&val,iserrp);
