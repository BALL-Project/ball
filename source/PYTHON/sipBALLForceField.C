...
static PyObject *sipDo_ForceField_insertComponent(PyObject *sipThisObj,PyObject *sipArgs)
{
...

	{
		...
		if (sipParseArgs(sipArgs,"I",sipCanConvertTo_ForceFieldComponent,&a0obj))
		{
			...
			sipConvertTo_ForceFieldComponent(a0obj,&a0,&iserr);
...
static PyObject *sipDo_ForceField_removeComponent(PyObject *sipThisObj,PyObject *sipArgs)
{
...

	{
		...
		if (sipParseArgs(sipArgs,"I",sipCanConvertTo_ForceFieldComponent,&a0obj))
		{
			...
			sipConvertTo_ForceFieldComponent(a0obj,(ForceFieldComponent **)&a0,&iserr);
...
void sipConvertTo_ForceField(PyObject *sipPy,ForceField **sipCppPtr,int *sipIsErr)
{
...
ForceField *sipForceConvertTo_ForceField(PyObject *valobj,int *iserrp)
{
	...
	if (sipCanConvertTo_ForceField(valobj))
	{
		...
		sipConvertTo_ForceField(valobj,&val,iserrp);
