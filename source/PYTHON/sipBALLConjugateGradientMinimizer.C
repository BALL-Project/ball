...
PyObject *sipNew_ConjugateGradientMinimizer(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	if (sipNew == NULL)
	{
		...
		if (sipParseArgs(sipArgs,"-II",sipCanConvertTo_ForceField,&a0obj,sipCanConvertTo_Options,&a1obj))
		{
			...
			sipConvertTo_ForceField(a0obj,&a0,&iserr);
			sipConvertTo_Options(a1obj,(Options **)&a1,&iserr);
	...
	if (sipNew == NULL)
	{
		...
		if (sipParseArgs(sipArgs,"-Il",sipCanConvertTo_ConjugateGradientMinimizer,&a0obj,&a1))
		{
			...
			sipConvertTo_ConjugateGradientMinimizer(a0obj,(ConjugateGradientMinimizer **)&a0,&iserr);
...
void sipConvertTo_ConjugateGradientMinimizer(PyObject *sipPy,ConjugateGradientMinimizer **sipCppPtr,int *sipIsErr)
{
...
ConjugateGradientMinimizer *sipForceConvertTo_ConjugateGradientMinimizer(PyObject *valobj,int *iserrp)
{
	...
	if (sipCanConvertTo_ConjugateGradientMinimizer(valobj))
	{
		...
		sipConvertTo_ConjugateGradientMinimizer(valobj,&val,iserrp);
