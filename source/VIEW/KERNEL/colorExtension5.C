...
// vi: set ts=2:
//
// $Id: colorExtension5.C,v 1.11 2003/08/26 09:18:47 oliver Exp $
...
namespace BALL
{
	...
	namespace VIEW
	{
		...
		void ColorExtension5::set(const ColorExtension5& color_extension)
			throw()
		{
		...
		void ColorExtension5::get(ColorExtension5& color_extension) const
			throw()
		{
