...
get_cmake_property(var GL_LIBS:UNINITIALIZED)
get_cmake_property(var GLU_LIBS:UNINITIALIZED)
...
set(CORE_LIBS "")  # libs for ball core, i.e. without anything for visualization
set(VIEW_LIBS "")  # libs needed by all visualization applications
...
macro(search_header package_name header)
	...
	if(NOT ${path} STREQUAL "")
		...
		if(${ARGV0} STREQUAL "Qt" AND NOT added_qt_pathes)
			...
			set(added_qt_pathes 1)
		endif(${ARGV0} STREQUAL "Qt" AND NOT added_qt_pathes)
...
macro(search_lib package_name libname static libs_list)
	...
	if(NOT LIB_${ARGV0} AND ${ARGV2} STREQUAL "static")
		search_lib(${ARGV0} ${ARGV1} dynamic ${ARGV3})
	endif(NOT LIB_${ARGV0} AND ${ARGV2} STREQUAL "static")
endmacro(search_lib package_name libname static libs_list)
...
macro(check_lib package_name lib static path libs_list)
	if(${ARGV2} STREQUAL "static")
		set(LIB_EXT ${STATICLIB_EXT})
	else(${ARGV2} STREQUAL "static")
		set(LIB_EXT ${DYLIB_EXT})
...
endmacro(check_lib package_name lib static path libs_list)
...
if(NOT DEFINED GSL_LIBS)
	search_lib(gsl gsl static CORE_LIBS)
	search_lib(gsl gslcblas static CORE_LIBS)
else(NOT DEFINED GSL_LIBS)
	check_lib(gsl gsl static ${GSL_LIBS} CORE_LIBS)
	check_lib(gsl gslcblas static ${GSL_LIBS} CORE_LIBS)
...
if(NOT DEFINED GLEW_LIBS)
	search_lib(glew GLEW static VIEW_GL_LIBS)
else(NOT DEFINED GLEW_LIBS)
	check_lib(glew GLEW static ${GLEW_LIBS} VIEW_GL_LIBS)
...
if(NOT DEFINED QT_LIBS)
	search_lib(Qt QtCore dynamic VIEW_LIBS)
	search_lib(Qt QtGui dynamic VIEW_LIBS)
else(NOT DEFINED QT_LIBS)
	check_lib(Qt QtCore dynamic ${QT_LIBS} VIEW_LIBS)
	check_lib(Qt QtGui dynamic ${QT_LIBS} VIEW_LIBS)
...
if(NOT DEFINED BOOST_LIBS)
	search_lib(boost boost_system-mt static CORE_LIBS)
	if(NOT USE_boost)
		search_lib(boost boost_system static CORE_LIBS)
	endif(NOT USE_boost)
else(NOT DEFINED BOOST_LIBS)
	check_lib(boost boost_system-mt static ${BOOST_LIBS} CORE_LIBS)
	if(NOT USE_boost)
		check_lib(boost boost_system static ${BOOST_LIBS} CORE_LIBS)
	endif(NOT USE_boost)
...
if(NOT DEFINED SVM_LIBS)
	search_lib(libsvm svm static QUEASY_LIBS)
else(NOT DEFINED SVM_LIBS)
	check_lib(libsvm svm static ${SVM_LIBS} QUEASY_LIBS)
...
if(NOT DEFINED QWT_LIBS)
	search_lib(qwt qwt static QUEASYVIZ_LIBS)
else(NOT DEFINED QWT_LIBS)
	check_lib(qwt qwt static ${QWT_LIBS} QUEASYVIZ_LIBS)
endif(NOT DEFINED QWT_LIBS)

if(NOT DEFINED GL_LIB)
	search_lib(GL GL static VIEW_GL_LIBS)
else(NOT DEFINED GL_LIB)
	check_lib(GL GL static ${GL_LIB} VIEW_GL_LIBS)
endif(NOT DEFINED GL_LIB)

if(NOT DEFINED GLU_LIB)
	search_lib(GLU GLU static VIEW_GL_LIBS)
else(NOT DEFINED GLU_LIB)
	check_lib(GLU GLU static ${GLU_LIB} VIEW_GL_LIBS)
endif(NOT DEFINED GLU_LIB)

if(NOT DEFINED LAPACK_LIB)
	search_lib(lapack lapack static QUEASY_LIBS)
else(NOT DEFINED LAPACK_LIB)
	check_lib(lapack lapack static ${LAPACK_LIB} QUEASY_LIBS)
endif(NOT DEFINED LAPACK_LIB)

if(NOT DEFINED BLAS_LIB)
	search_lib(blas blas static QUEASY_LIBS)
else(NOT DEFINED BLAS_LIB)
	check_lib(blas blas static ${BLAS_LIB} QUEASY_LIBS)
...
if(LIB_lapack)
	...
	if(NOT LIB_blas)
		...
		if(NOT DEFINED LAPACK_LIB)
			search_lib(lapack blas static QUEASY_LIBS)
			set(USE_lapack 1)
			set(LIB_blas ${LIB_lapack})
		else(NOT DEFINED LAPACK_LIB)
			check_lib(blas blas static ${LAPACK_LIB} QUEASY_LIBS)
		endif(NOT DEFINED LAPACK_LIB)
	endif(NOT LIB_blas)
	
	if(NOT DEFINED FORTRAN_LIB)
		search_lib(fortran gfortran static QUEASY_LIBS)
	else(NOT DEFINED FORTRAN_LIB)
		check_lib(fortran gfortran static ${FORTRAN_LIB} QUEASY_LIBS)
