...
// vi: set ts=2:
//
// $Id: BinaryFileAdaptor_test.C,v 1.9 2005/12/23 17:03:07 amoll Exp $
...
START_TEST(BinaryFileAdaptor, "$Id: BinaryFileAdaptor_test.C,v 1.9 2005/12/23 17:03:07 amoll Exp $")
