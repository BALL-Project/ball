...
// vi: set ts=2:
//
// $Id: BinaryFileAdaptor_test.C,v 1.8.10.1 2006/02/14 15:03:03 amoll Exp $
...
START_TEST(BinaryFileAdaptor, "$Id: BinaryFileAdaptor_test.C,v 1.8.10.1 2006/02/14 15:03:03 amoll Exp $")
