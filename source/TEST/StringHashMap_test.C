...
// vi: set ts=2:
//
// $Id: StringHashMap_test.C,v 1.2.2.1 2003/01/07 13:22:55 anker Exp $
...
START_TEST(StringHashMap, "$Id: StringHashMap_test.C,v 1.2.2.1 2003/01/07 13:22:55 anker Exp $")
