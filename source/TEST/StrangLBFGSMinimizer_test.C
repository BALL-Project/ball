...
CHECK(StrangLBFGSMinimizer::setNumOfStoredVects(Size num))	
	StrangLBFGSMinimizer e_min;
	e_min.setNumOfStoredVects(11);
	TEST_EQUAL(e_min.getNumOfStoredVects(), 11)
RESULT

CHECK(StrangLBFGSMinimizer::getNumOfStoredVects())	
	StrangLBFGSMinimizer e_min;
	TEST_EQUAL(e_min.getNumOfStoredVects(), 5)
RESULT

CHECK(StrangLBFGSMinimizer::minimize(Size, bool))
	System S;
...
CHECK(StrangLBFGSMinimizer::minimize(Size, bool) AlaAla)	
	System S;
...
CHECK(StrangLBFGSMinimizer::minimize(Size, bool) Ethane)
	System S;
