...
// vi: set ts=2:
//
// $Id: LineBasedFile_test.C,v 1.19.6.1 2006/02/14 15:03:07 amoll Exp $
//
...
START_TEST(LineBasedFile, "$Id: LineBasedFile_test.C,v 1.19.6.1 2006/02/14 15:03:07 amoll Exp $")
