...
// vi: set ts=2:
//
// $Id: TransformationManager_test.C,v 1.5.2.1 2003/01/07 13:23:01 anker Exp $
...
START_TEST(TransformationManager, "$Id: TransformationManager_test.C,v 1.5.2.1 2003/01/07 13:23:01 anker Exp $")
