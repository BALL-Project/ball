...
// vi: set ts=2:
//
// $Id: SecondaryStructure_test.C,v 1.9.2.1 2003/01/07 13:22:50 anker Exp $
...
START_TEST(SecondaryStructure, "$Id: SecondaryStructure_test.C,v 1.9.2.1 2003/01/07 13:22:50 anker Exp $")
