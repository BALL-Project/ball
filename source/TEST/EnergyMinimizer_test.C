...
// vi: set ts=2:
//
// $Id: EnergyMinimizer_test.C,v 1.2.2.2 2003/02/05 15:33:56 anker Exp $
...
START_TEST(EnergyMinimizer, "$Id: EnergyMinimizer_test.C,v 1.2.2.2 2003/02/05 15:33:56 anker Exp $")
