// $Id: SmilesParser_test.C,v 1.2.4.1 2002/11/26 19:36:40 oliver Exp $
...
START_TEST(SmilesParser, "$Id: SmilesParser_test.C,v 1.2.4.1 2002/11/26 19:36:40 oliver Exp $")
