...
// vi: set ts=2:
//
// $Id: XDRPersistenceManager_test.C,v 1.6.2.3 2003/02/05 13:22:08 anker Exp $
...
START_TEST(XDRPersistenceManager, "$Id: XDRPersistenceManager_test.C,v 1.6.2.3 2003/02/05 13:22:08 anker Exp $")
