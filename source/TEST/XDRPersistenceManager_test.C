...
// vi: set ts=2:
//
// $Id: XDRPersistenceManager_test.C,v 1.20.8.1 2006/05/15 23:18:49 amoll Exp $
//
...
START_TEST(XDRPersistenceManager, "$Id: XDRPersistenceManager_test.C,v 1.20.8.1 2006/05/15 23:18:49 amoll Exp $")
