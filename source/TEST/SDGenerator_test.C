...
// vi: set ts=2:
//
// $Id: SDGenerator_test.C,v 1.1 2006/06/06 11:31:43 oliver Exp $
//
// Author:
//   Holger Franken
//
...
START_TEST(SDGenerator, "$Id: SDGenerator_test.C,v 1.1 2006/06/06 11:31:43 oliver Exp $")
...
MOLFile infile_2("data/input_SDGenerator_test_2.mol");
...
CHECK(vector<vector<Atom*> sequenceRings(vector<vector<Atom*> >& ringsystem))
	...
	TEST_EQUAL(seq_ringsys[0][3],unseq_ringsys[0][4])
	TEST_EQUAL(seq_ringsys[0][4],unseq_ringsys[0][3])
