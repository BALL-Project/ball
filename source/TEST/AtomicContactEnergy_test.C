// $Id: AtomicContactEnergy_test.C,v 1.1 2000/01/16 16:34:14 oliver Exp $
...
START_TEST(AtomicContactEnergy, "$Id: AtomicContactEnergy_test.C,v 1.1 2000/01/16 16:34:14 oliver Exp $")
