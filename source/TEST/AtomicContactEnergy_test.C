...
// vi: set ts=2:
//
// $Id: AtomicContactEnergy_test.C,v 1.7 2002/02/27 12:24:24 sturm Exp $
...
START_TEST(AtomicContactEnergy, "$Id: AtomicContactEnergy_test.C,v 1.7 2002/02/27 12:24:24 sturm Exp $")
