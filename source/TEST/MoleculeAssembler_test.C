...
// vi: set ts=2:
//
// $Id: MoleculeAssembler_test.C,v 1.2.2.1 2006/06/26 18:38:54 oliver Exp $
//
// Author:
//   Holger Franken
//
...
START_TEST(MoleculeAssembler, "$Id: MoleculeAssembler_test.C,v 1.2.2.1 2006/06/26 18:38:54 oliver Exp $")
