...
// vi: set ts=2:
//
// $Id: MoleculeAssembler_test.C,v 1.5.8.1 2007/03/25 21:47:21 oliver Exp $
//
// Author:
//   Holger Franken
//
...
START_TEST(MoleculeAssembler, "$Id: MoleculeAssembler_test.C,v 1.5.8.1 2007/03/25 21:47:21 oliver Exp $")
