// $Id: RegularExpression_test.C,v 1.10.4.1 2002/12/06 15:29:09 oliver Exp $
...
START_TEST(RegularExpression, "$Id: RegularExpression_test.C,v 1.10.4.1 2002/12/06 15:29:09 oliver Exp $")
