...
// vi: set ts=2:
//
// $Id: RegularExpression_test.C,v 1.13 2003/05/25 21:38:11 oliver Exp $
//
...
START_TEST(RegularExpression, "$Id: RegularExpression_test.C,v 1.13 2003/05/25 21:38:11 oliver Exp $")
