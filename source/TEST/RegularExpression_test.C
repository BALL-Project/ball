...
// vi: set ts=2:
//
// $Id: RegularExpression_test.C,v 1.12 2002/12/12 11:34:44 oliver Exp $
...
START_TEST(RegularExpression, "$Id: RegularExpression_test.C,v 1.12 2002/12/12 11:34:44 oliver Exp $")
