...
// vi: set ts=2:
//
// $Id: RotamerLibrary_test.C,v 1.9.4.1 2005/07/18 09:03:25 oliver Exp $
//
...
START_TEST(RotamerLibrary, "$Id: RotamerLibrary_test.C,v 1.9.4.1 2005/07/18 09:03:25 oliver Exp $")
