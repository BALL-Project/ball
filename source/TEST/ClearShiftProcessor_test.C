...
// vi: set ts=2:
//
// $Id: ClearShiftProcessor_test.C,v 1.5.2.1 2003/01/07 13:22:19 anker Exp $
...
START_TEST(ClearShiftProcessor, "$Id: ClearShiftProcessor_test.C,v 1.5.2.1 2003/01/07 13:22:19 anker Exp $")
