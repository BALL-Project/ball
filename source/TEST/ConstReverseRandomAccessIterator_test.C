...
// vi: set ts=2:
//
// $Id: ConstReverseRandomAccessIterator_test.C,v 1.1 2003/05/28 16:51:09 oliver Exp $
//
...
typedef ConstReverseRandomAccessIterator<vector<float>, float, VectorIteratorPosition_, VectorIteratorTraits_<float> > MyIterator;

START_TEST(ConstReverseRandomAccessIterator, "$Id: ConstReverseRandomAccessIterator_test.C,v 1.1 2003/05/28 16:51:09 oliver Exp $")
...
CHECK(ConstReverseRandomAccessIterator())
...
CHECK(ConstReverseRandomAccessIterator(const Container& container))
...
CHECK(operator - (ConstReverseRandomAccessIterator))
