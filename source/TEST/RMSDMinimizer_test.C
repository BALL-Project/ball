...
// vi: set ts=2:
//
// $Id: RMSDMinimizer_test.C,v 1.1.4.1 2006/02/14 15:03:09 amoll Exp $
//
// Author:
//   Oliver Kohlbacher
//
...
START_TEST(RMSDMinimizer, "$Id: RMSDMinimizer_test.C,v 1.1.4.1 2006/02/14 15:03:09 amoll Exp $")
