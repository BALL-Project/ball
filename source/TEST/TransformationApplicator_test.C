...
// vi: set ts=2:
//
// $Id: TransformationApplicator_test.C,v 1.1.1.1.2.1 2003/01/07 13:23:01 anker Exp $
#include <BALL/CONCEPT/classTest.h>

#include <BALL/STRUCTURE/geometricTransformations.h>
#include <BALL/KERNEL/fragment.h>

START_TEST(TransformationApplictor, "$Id: TransformationApplicator_test.C,v 1.1.1.1.2.1 2003/01/07 13:23:01 anker Exp $")
