...
// vi: set ts=2:
//
// $Id: ClaverieParameter_test.C,v 1.5.2.1 2003/01/07 13:22:18 anker Exp $
...
START_TEST(ClaverieParameter, "$Id: ClaverieParameter_test.C,v 1.5.2.1 2003/01/07 13:22:18 anker Exp $")
