...
// vi: set ts=2:
//
// $Id: ClaverieParameter_test.C,v 1.5.2.2 2003/02/05 15:33:54 anker Exp $
...
START_TEST(ClaverieParameter, "$Id: ClaverieParameter_test.C,v 1.5.2.2 2003/02/05 15:33:54 anker Exp $")
