...
// vi: set ts=2:
//
// $Id: ConstRandomAccessIterator_test.C,v 1.1 2003/05/28 16:51:09 oliver Exp $
//
...
START_TEST(ConstRandomAccessIterator, "$Id: ConstRandomAccessIterator_test.C,v 1.1 2003/05/28 16:51:09 oliver Exp $")
...
CHECK(ConstRandomAccessIterator())
...
CHECK(Detailed cstr)
	ConstBaseIterator<vector<float>, float, VectorIteratorPosition_, VectorIteratorTraits_<float> > bi;
	MyIterator m2(bi);
RESULT
...
CHECK(operator - (ConstRandomAccessIterator))
