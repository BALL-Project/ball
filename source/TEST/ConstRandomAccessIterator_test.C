...
// vi: set ts=2:
//
// $Id: ConstRandomAccessIterator_test.C,v 1.3 2003/06/29 09:12:43 oliver Exp $
//
...
START_TEST(ConstRandomAccessIterator, "$Id: ConstRandomAccessIterator_test.C,v 1.3 2003/06/29 09:12:43 oliver Exp $")
