...
// vi: set ts=2:
//
// $Id: ConstRandomAccessIterator_test.C,v 1.6 2003/07/01 18:15:05 oliver Exp $
//
...
START_TEST(ConstRandomAccessIterator, "$Id: ConstRandomAccessIterator_test.C,v 1.6 2003/07/01 18:15:05 oliver Exp $")
