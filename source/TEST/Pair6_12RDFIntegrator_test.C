...
// vi: set ts=2:
//
// $Id: Pair6_12RDFIntegrator_test.C,v 1.7.2.1 2003/01/07 13:22:39 anker Exp $
...
START_TEST(Pair6_12RDFIntegrator, "$Id: Pair6_12RDFIntegrator_test.C,v 1.7.2.1 2003/01/07 13:22:39 anker Exp $")
