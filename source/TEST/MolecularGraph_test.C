...
// vi: set ts=2:
//
// $Id: MolecularGraph_test.C,v 1.3.2.1 2003/01/07 13:22:34 anker Exp $
...
START_TEST(MolecularGraph, "$Id: MolecularGraph_test.C,v 1.3.2.1 2003/01/07 13:22:34 anker Exp $")
