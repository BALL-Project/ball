...
// vi: set ts=2:
//
// $Id: HaighMallionShiftProcessor_test.C,v 1.7.2.1 2003/01/07 13:22:27 anker Exp $
...
START_TEST(HaighMallionShiftProcessor, "$Id: HaighMallionShiftProcessor_test.C,v 1.7.2.1 2003/01/07 13:22:27 anker Exp $")
