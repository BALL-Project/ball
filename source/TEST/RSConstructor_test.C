...
// vi: set ts=2:
//
// $Id: RSConstructor_test.C,v 1.3.8.1 2007/03/25 21:48:48 oliver Exp $
//
// Author:
//   Holger Franken
//
...
START_TEST(RSConstructor, "$Id: RSConstructor_test.C,v 1.3.8.1 2007/03/25 21:48:48 oliver Exp $")
