...
// vi: set ts=2:
//
// $Id: AnalyticalGeometry_test.C,v 1.26.2.1 2003/01/07 13:22:13 anker Exp $
...
START_TEST(AnalyticalGeometry, "$Id: AnalyticalGeometry_test.C,v 1.26.2.1 2003/01/07 13:22:13 anker Exp $")
