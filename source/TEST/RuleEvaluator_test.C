// $Id: RuleEvaluator_test.C,v 1.5.4.1 2002/12/10 14:08:10 anker Exp $
...
START_TEST(RuleEvaluator, "$Id: RuleEvaluator_test.C,v 1.5.4.1 2002/12/10 14:08:10 anker Exp $")
