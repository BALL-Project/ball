...
// vi: set ts=2:
//
// $Id: RuleEvaluator_test.C,v 1.5.2.1 2003/01/07 13:22:50 anker Exp $
...
START_TEST(RuleEvaluator, "$Id: RuleEvaluator_test.C,v 1.5.2.1 2003/01/07 13:22:50 anker Exp $")
