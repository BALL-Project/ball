// $Id: CreateSpectrumProcessor_test.C,v 1.1 2000/09/22 00:33:47 amoll Exp $
...
START_TEST(CreateSpectrumProcessor, "$Id: CreateSpectrumProcessor_test.C,v 1.1 2000/09/22 00:33:47 amoll Exp $")
...
CHECK(CreateSpectrumProcessor::CreateSpectrumProcessor(const CreateSpectrumProcessor& processor) throw())
  //BAUSTELLE
RESULT


CHECK(CreateSpectrumProcessor::init() throw())
  //BAUSTELLE
RESULT
...
CHECK(CreateSpectrumProcessor::Processor::Result operator () (Composite& composite) throw())
  //BAUSTELLE
RESULT
...
Parameters parameters("data/CreateSpectrumProcessor_test.ini");

CHECK(charge assignment)
	CreateSpectrumProcessor cp;
