...
// vi: set ts=2:
//
// $Id: StructureMapper_test.C,v 1.12.6.1 2006/02/14 15:03:12 amoll Exp $
//
...
START_TEST(StructureMapper, "$Id: StructureMapper_test.C,v 1.12.6.1 2006/02/14 15:03:12 amoll Exp $")
