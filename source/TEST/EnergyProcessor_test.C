...
// vi: set ts=2:
//
// $Id: EnergyProcessor_test.C,v 1.6.2.1 2003/01/07 13:22:23 anker Exp $
...
START_TEST(EnergyProcessor, "$Id: EnergyProcessor_test.C,v 1.6.2.1 2003/01/07 13:22:23 anker Exp $")
