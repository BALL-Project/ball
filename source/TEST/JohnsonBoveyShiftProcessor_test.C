...
// vi: set ts=2:
//
// $Id: JohnsonBoveyShiftProcessor_test.C,v 1.12 2002/02/27 12:24:36 sturm Exp $
...
START_TEST(JohnsonBoveyShiftProcessor, "$Id: JohnsonBoveyShiftProcessor_test.C,v 1.12 2002/02/27 12:24:36 sturm Exp $")
