// $Id: AtomContainer_test.C,v 1.6.4.1 2002/12/06 13:25:38 oliver Exp $
...
START_TEST(AtomContainer, "$Id: AtomContainer_test.C,v 1.6.4.1 2002/12/06 13:25:38 oliver Exp $")
