...
// vi: set ts=2:
//
// $Id: AssignShiftProcessor_test.C,v 1.14.2.1 2004/05/07 13:09:46 amoll Exp $
...
START_TEST(AssignShiftProcessor, "$Id: AssignShiftProcessor_test.C,v 1.14.2.1 2004/05/07 13:09:46 amoll Exp $")
