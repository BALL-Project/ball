...
// vi: set ts=2:
//
// $Id: SteepestDescentMinimizer_test.C,v 1.1 2003/02/02 10:15:52 oliver Exp $
...
START_TEST(ConjugateGradienMinimizer, "$Id: SteepestDescentMinimizer_test.C,v 1.1 2003/02/02 10:15:52 oliver Exp $")
