...
// vi: set ts=2:
//
// $Id: AnalyticalSES_test.C,v 1.8.2.1 2003/01/07 13:22:13 anker Exp $
...
START_TEST(AnalyticalSES, "$Id: AnalyticalSES_test.C,v 1.8.2.1 2003/01/07 13:22:13 anker Exp $")
