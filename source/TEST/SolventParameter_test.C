...
// vi: set ts=2:
//
// $Id: SolventParameter_test.C,v 1.13 2002/02/27 12:24:57 sturm Exp $
...
START_TEST(SolventParameter, "$Id: SolventParameter_test.C,v 1.13 2002/02/27 12:24:57 sturm Exp $")
