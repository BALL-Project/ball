...
// vi: set ts=2:
//
// $Id: RegularData1D_test.C,v 1.11.2.1 2003/01/07 13:22:48 anker Exp $
...
START_TEST(RegularData1D, "$Id: RegularData1D_test.C,v 1.11.2.1 2003/01/07 13:22:48 anker Exp $")
