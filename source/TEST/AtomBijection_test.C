...
// vi: set ts=2:
//
// $Id: AtomBijection_test.C,v 1.1.6.1.2.1 2006/08/31 14:06:18 leonhardt Exp $
//
// Author:
//   Oliver Kohlbacher
//
...
START_TEST(AtomBijection, "$Id: AtomBijection_test.C,v 1.1.6.1.2.1 2006/08/31 14:06:18 leonhardt Exp $")
