...
// vi: set ts=2:
//
// $Id: AtomBijection_test.C,v 1.1.4.1 2006/02/14 15:03:03 amoll Exp $
//
// Author:
//   Oliver Kohlbacher
//
...
START_TEST(AtomBijection, "$Id: AtomBijection_test.C,v 1.1.4.1 2006/02/14 15:03:03 amoll Exp $")
