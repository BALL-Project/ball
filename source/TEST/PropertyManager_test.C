...
// vi: set ts=2:
//
// $Id: PropertyManager_test.C,v 1.20 2002/02/27 12:24:47 sturm Exp $
...
START_TEST(PropertyManager, "$Id: PropertyManager_test.C,v 1.20 2002/02/27 12:24:47 sturm Exp $")
