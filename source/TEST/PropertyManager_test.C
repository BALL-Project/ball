...
// vi: set ts=2:
//
// $Id: PropertyManager_test.C,v 1.19.2.1 2003/01/07 13:22:44 anker Exp $
...
START_TEST(PropertyManager, "$Id: PropertyManager_test.C,v 1.19.2.1 2003/01/07 13:22:44 anker Exp $")
