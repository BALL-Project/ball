...
// vi: set ts=2:
//
// $Id: CompositeChildcompositeIteratorTraits_test.C,v 1.1 2003/06/19 10:45:51 oliver Exp $
//
...
START_TEST(CompositeIteratorTraits, "$Id: CompositeChildcompositeIteratorTraits_test.C,v 1.1 2003/06/19 10:45:51 oliver Exp $")
