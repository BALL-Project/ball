...
// vi: set ts=2:
//
// $Id: ConstBidirectionalIterator_test.C,v 1.1 2003/06/11 16:09:26 oliver Exp $
//
...
START_TEST(RandomAccessIterator, "$Id: ConstBidirectionalIterator_test.C,v 1.1 2003/06/11 16:09:26 oliver Exp $")
