// $Id: TVector4_test.C,v 1.1 2000/02/19 01:45:54 amoll Exp $
...
START_TEST(TVector4, "$Id: TVector4_test.C,v 1.1 2000/02/19 01:45:54 amoll Exp $")
...
CHECK(TVector4::normalize())
	...
	TEST_EQUAL(v[0], 4/14)
	TEST_EQUAL(v[1], 9/14)
	TEST_EQUAL(v[2], 16/14)
	TEST_EQUAL(v[3], 25/14)
	v = Vector4(0,0,0,0);
...
CHECK(TVector4<T>::swap(TVector4<T>& v))
	v  = Vector4(1,2,3,4);
	v2 = Vector4(4,3,2,1);
	Vector4 u  = Vector4(1,2,3,4);
	Vector4 u2 = Vector4(4,3,2,1);
	v.swap(v2);
	v2 = Vector4(1,2,3,4);
	TEST_EQUAL(v2, u)
	TEST_EQUAL(v, u2)
