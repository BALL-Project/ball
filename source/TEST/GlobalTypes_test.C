...
// vi: set ts=2:
//
// $Id: GlobalTypes_test.C,v 1.2.2.1 2003/01/07 13:22:27 anker Exp $
...
START_TEST(sizes of the global data types, "$Id: GlobalTypes_test.C,v 1.2.2.1 2003/01/07 13:22:27 anker Exp $")
