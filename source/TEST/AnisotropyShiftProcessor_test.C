...
// vi: set ts=2:
//
// $Id: AnisotropyShiftProcessor_test.C,v 1.7 2002/02/27 12:24:22 sturm Exp $
...
START_TEST(AnisotropyShiftProcessor, "$Id: AnisotropyShiftProcessor_test.C,v 1.7 2002/02/27 12:24:22 sturm Exp $")
