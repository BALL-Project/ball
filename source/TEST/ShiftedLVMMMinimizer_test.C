...
CHECK(ShiftedLVMMMinimizer::setNumOfColumns(Size num))	
	ShiftedLVMMMinimizer e_min;
	e_min.setNumOfColumns(11);
	TEST_EQUAL(e_min.getNumOfColumns(), 11)
RESULT

CHECK(ShiftedLVMMMinimizer::getNumOfColumns() const)	
	ShiftedLVMMMinimizer e_min;
	TEST_EQUAL(e_min.getNumOfColumns(), 5)
RESULT
